...
import com.hw.util.FileDownload;
import com.hw.util.FileUpload;
import com.hw.util.GetPinyin;
import com.hw.util.Jurisdiction;
import com.hw.util.ObjectExcelRead;
import com.hw.util.PageData;
import com.hw.util.ObjectExcelView;
import com.hw.util.PathUtil;
import com.hw.util.Tools;

/**
 * Created : Panda.HuangWei
 * Date : 2016/6/27 17:22
 */
@Controller
...
public class UserController extends BaseController {
    ...
    public ModelAndView goEditU() throws Exception {
        ...
        mv.addObject("customerList",SelectCache.getInstance().getAllCustomer());
