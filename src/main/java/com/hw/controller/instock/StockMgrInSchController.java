 ...
 */
@Controller
@RequestMapping(value="/stockmgrinsch")
public class StockMgrInSchController extends BaseController {
	
	String menuUrl = "stockmgrinsch/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save(Page page) throws Exception{
		...
		if (Const.OPT_EVEN_1.equals(optEven)) {
			try {
				...
				mv.setViewName("instock/stockmgrinsch_edit");
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("instock/stockmgrinsch_list");
	...
	private void setSelect(ModelAndView mv,List<Select> list) {
	...
	public ModelAndView goEditDtl(){
		...
		try {
			...
			mv.setViewName("instock/stockdtlmgrinsch_edit");
	...
	private void setEaProd(PageData rs,PageData src) {
		rs.put("WEIGHT_UNIT_TYPE", src.getString("WEIGHT_UNIT_TYPE"));
		rs.put("SUTTLE_UNIT_TYPE",src.getString("SUTTLE_UNIT_TYPE"));
		rs.put("VOLUME_UNIT_TYPE", src.getString("VOLUME_UNIT_TYPE"));
		//产品配置的毛重，净重
	...
	public ModelAndView readExcel(@RequestParam(value = "excel", required = false) MultipartFile file,
		...
		if (null != file && !file.isEmpty()) {
			...
			List<PageData> auditRsList = auditData(listPd, prodCodeSet);
	...
	private List<PageData> auditData(List<PageData> listPd,Set<String> prodCodeList) {
