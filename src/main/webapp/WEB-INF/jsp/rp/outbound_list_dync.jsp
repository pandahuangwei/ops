				...
				<form action="outbound/list.do" method="post" name="Form" id="Form">
									...
									<div class="content">
										...
										<table id="table_prod_dtl" class="table table-striped table-condensed table-hover">
											...
											<tr>
												...
												<td style="width:110px;text-align: right;padding-top: 13px;">DATE_CODE</td>
												<td><input  id="DATE_CODE" type="text" name="DATE_CODE" value="${pd.DATE_CODE}" /></td>

											</tr>
											<tr>
												<td style="width:110px;text-align: right;padding-top: 13px;">LOT_CODE</td>
					...
					<table id="table_report" class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<th class="center">CartonID</th>
							<th class="center">Invoice#</th>
							<th class="center">Item Code</th>
							<th class="center">Lot Code(Carton)</th>
							<th class="center">Date Code(Carton)</th>
							<th class="center">SeparateQty(Carton)</th>
							<th class="center">COO(Carton)</th>
							<th class="center">BIN(Carton)</th>
							<th class="center">SPS</th>
							<th class="center">Remark(1)</th>
							<th class="center">Remark(2)</th>
							<th class="center">Lot Code</th>
							<th class="center">Date Code</th>
							<th class="center">Qty</th>
							<th class="center">Separate Qty</th>
							<th class="center">Shipper/Consignee</th>
							<c:choose>
								...
								<c:if test="${QX.cha == 1 }">
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr id="${var.COMB_ID}">
											...
											<td>${var.CARTONID}</td>
											<td>${var.INVOICE_NO}</td>
											<td>${var.ITEM_CODE}</td>

											<td>${var.BOX_LOT_NO}</td>
											<td>${var.BOX_DATE_CODE}</td>
											<td>${var.BOX_SEPARATE_QTY}</td>
											<td>${var.BOX_COO}</td>
