<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid"><%--<i class="icon-leaf"></i>--%>
			  <a class="brand"><small> <img src="static/login/logn.png" alt="Logo" /></small> </a>
			  
			  <ul class="nav ace-nav pull-right">

				<c:if test="${QX.add == 2 }">
					<li id="procmsg" class="grey">
					...
					<li id="talkmsg" class="purple" onclick="creatw();">
