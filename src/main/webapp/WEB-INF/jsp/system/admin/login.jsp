		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group normal_text">
					<h3>
						<img src="static/login/logon.png" alt="Logo" />
					</h3>
				</div>
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<span class="pull-right" style="padding-right:3%;"><a
							href="javascript:quxiao();" class="btn btn-success">关闭</a></span> <span
			...
			<footer class="footer">
				<p>Copyright © HW 2017.All Rights Reserved</p>
			</footer>
		</div>
	</div><!--
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = loginname+",hw,"+password+",hw,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
