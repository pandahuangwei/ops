...
<body>
	<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table width="400">
			...
			<tr class="info">
				<td style="width:100px;text-align: right;padding-top: 13px;">职位/角色<span class="red">*</span></td>
				<td>
			...
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">用户名<span class="red">*</span></td>
				<td><input type="text" name="USERNAME" id="loginname" value="${pd.USERNAME }" maxlength="32" placeholder="这里输入用户名" title="用户名"/></td>
			</tr>
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">编号<span class="red">*</span></td>
			...
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">密码<span class="red">*</span></td>
				<td><input type="password" name="PASSWORD" id="password"  maxlength="32" placeholder="输入密码" title="密码"/></td>
			</tr>
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">确认密码<span class="red">*</span></td>
				<td><input type="password" name="chkpwd" id="chkpwd"  maxlength="32" placeholder="确认密码" title="确认密码" /></td>
			</tr>
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">姓名<span class="red">*</span></td>
				<td><input type="text" name="NAME" id="name"  value="${pd.NAME }"  maxlength="32" placeholder="这里输入姓名" title="姓名"/></td>
			</tr>
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">手机号<span class="red">*</span></td>
				<td><input type="number" name="PHONE" id="PHONE"  value="${pd.PHONE }"  maxlength="32" placeholder="这里输入手机号" title="手机号"/></td>
			</tr>
			<tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">邮箱<span class="red">*</span></td>
            ...
            <tr>
				<td style="width:100px;text-align: right;padding-top: 13px;">外部客户</td>
				<td><input type='checkbox' id="OUT_CUSTOMER" name='OUT_CUSTOMER' value="1"
						   <c:if test="${pd.OUT_CUSTOMER eq 1 }">checked="checked" </c:if>/><span class="lbl"></span>
				</td>
			</tr>
			<tr>
				<td style="width:110px;text-align: right;padding-top: 13px;">归属客户</td>
