...
<head>
    ...
    <script type="text/javascript">
        ...
        function hasStock() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=basePath%>receivopt/hadInStockCommonReceive.do',
                ...
                success: function (data) {
                    ...
                    if ("success" != data.result) {
                        ...
                        result = false;
                        //$('#INSTOCK_NO').focus(); SEPERATOR QR2D QRFLAG
                    } else {
                        result = true;
            ...
            <div class="widget-body">
                    ...
                    <div class="slim-scroll" data-height="125">
                        <div class="content">
                            <table id="table_report" class="table table-striped  table-hover table-condensed">
                                ...
                                <tr>
                                    <td style="width:120px;text-align: right;padding-top: 13px;">入库单号<span
                                            class="red">*</span></td>
                                    <td colspan="7"><input type="text" onblur="hasStock()"
                                                           style="background-color: yellow" name="INSTOCK_NO"
                                                           id="INSTOCK_NO" value="${pd.INSTOCK_NO}" maxlength="32"
                                                           placeholder=" " title="入库单号"/>

                                        二维码
                                        <input class="input-small" type='checkbox' id="QR_CODE_USE" name='QR_CODE_USE'
                                               value="${pd.QR_CODE_USE}"
                                               onclick="setQrCode(this);"
                                               <c:if test="${pd.QR_CODE_USE eq 1 }">checked="checked" </c:if>/><span
                                                class="lbl"></span>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="BIG_BOX_NO" id="BIG_BOX_NO" onblur="auditBigBoxNo();"
                                               value="${pd.BIG_BOX_NO}" maxlength="32" placeholder=" "
                                               title="BIG_BOX_NO"/></td>

                                    <td style="width:120px;text-align: right;padding-top: 13px;">板号</td>
                                    <td><input type="text" name="BOARD_NO" id="BOARD_NO" value="${pd.BOARD_NO}"
                                               maxlength="32" placeholder=" " title="板号"/></td>

                                </tr>

                                <tr>
                                    <td style="width:120px;text-align: right;padding-top: 13px;">箱号<span
                                            class="red">*</span></td>
                                    <td colspan="7"><input type="text" onblur="auditBoxNo();" name="BOX_NO" id="BOX_NO"
                                                           value="${pd.BOX_NO}" maxlength="32" placeholder=" "
                                                           title="箱号"/></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="7"><input class="span9" type="text" name="QR_CODE" id="QR_CODE"
                                                           value="${pd.QR_CODE}"
                                                           <c:if test="${pd.QR_CODE_USE eq 0 }">readOnly="readOnly" </c:if>
                                                            maxlength="256"
                                                           placeholder=" " title="二维码"/>
                                    </td>
                                   <%-- onchange="splitQrCode(this.value)"--%>
                                </tr>

                                <tr>
                                    <td style="width:110px;text-align: right;padding-top: 13px;">前缀/料号<span class="red">*</span>
                                    </td>
                                    <td><input class="input-mini" type="text" name="PREFIX_PROD"
                                                           id="PREFIX_PROD" value="${pd.PREFIX_PROD}" maxlength="32"
                                                           placeholder=" " title="前缀料号"/>
                                        <input type="text" name="PROD_CODE" id="PROD_CODE"
                                               value="${pd.PROD_CODE}" maxlength="32" placeholder=" " title="料号"/>
                                    </td>
                                   <%-- onblur="hasProd();"--%>
                                ...
                                <tr>
                                    <td style="width:110px;text-align: right;padding-top: 13px;">前缀/扫描LotCode</td>
                                    <td><input class="input-mini" type="text" name="PREFIX_LOTNO" id="PREFIX_LOTNO"
                                               value="${pd.PREFIX_LOTNO}" maxlength="32" placeholder=" "
                                               title="前缀LOTNO"/>
                                        <input class="input-small" type="text" name="LOT_NO" id="LOT_NO"
                                               value="${pd.LOT_NO}" maxlength="32" placeholder=" " title="LOT_NO"/></td>
                                ...
                                <tr>
                                    <td style="width:120px;text-align: right;padding-top: 13px;">前缀/扫描码/数量<span
                                            class="red">*</span></td>
                                    <td ><input class="input-mini" type="text" name="PREFIX_SCAN"
                                                            id="PREFIX_SCAN" value="${pd.PREFIX_SCAN}" maxlength="32"
                                                            placeholder="" title="前缀扫描码数量"/>
                                        <input class="input-small" type="text" name="SCAN_CODE" id="SCAN_CODE"
                                               value="${pd.SCAN_CODE}" maxlength="32" placeholder="" title="扫描码"/>
                                        <input class="input-small" type="number" onblur="hasEA();" min="1"
                                               name="RECEIV_QTY" id="RECEIV_QTY"
                                               onkeyup="value=value.replace(/[^/d] /g,'') "
                                               onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^/d]/g,''))"
                                               value="${pd.RECEIV_QTY}" maxlength="8" placeholder="0" title="描码数量"/>
                                        <%--COO colspan="3"
                                        <input type="text" name="COO" id="COO" value="${pd.COO}" maxlength="32"
                                               placeholder=" " title="COO"/>--%>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td ><input class="input-mini" type="text" name="REMARK1"
                                        ...
                                        <input class="input-small" type="text" onblur="hasEA();" min="1"
                                               ...
                                               value="${pd.REMARK3}" maxlength="32" placeholder=" " title="Remark3"/>
                                ...
                                <tr>
                                    ...
                                    <td> <input class="input-medium" type="text" name="INV_NO" id="INV_NO" value="${pd.INV_NO}" maxlength="32" placeholder=" " title="INV_NO"/>
                                    </td>
                                 ...
                                 <%--
                                    ...
                                    <td><input type="number" readOnly="readOnly" min="0" name="CNT_SCAN" id="CNT_SCAN"
                                               value="${pd.CNT_SCAN}" maxlength="32" placeholder=" " title="CNT_SCAN"
                                               style="text-align: right"/></td>

                                    <td style="width:110px;text-align: right;padding-top: 13px;">已扫描箱数</td>
                                    <td><input type="number" readOnly="readOnly" min="0" name="BOX_SCAN" id="BOX_SCAN"
                                               value="${pd.BOX_SCAN}" maxlength="32" placeholder=" " title="PACKAGE QTY"
                                               style="text-align: right"/></td>--%>
                                </tr>
                ...
                <div class="widget-toolbox" align="center">
                    <div class="btn-toolbar">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                        <div class="btn-group">
                            <a class="btn btn-mini btn-info" onclick="top.Dialog.close();"><span
                                    class="icon-search"></span>扫描完成</a>
                        </div>
                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                        <div class="btn-group">
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-mini btn-warning" onclick="cleanPREFIX();"><span
                                    class="icon-refresh"></span>清除前置码</a>
                        </div>
                    </div>
...
<script type="text/javascript">
   ...
   // SEPERATOR QR2D QRFLAG
    function splitQrCode(value) {
       ...
       /* if (columArr.length != arr.length ) {
            $("#QR_CODE").tips({
                side: 3,
                msg: '扫描的二维码与客户设置的长度不一致',
                bg: '#AE81FF',
                time: 2
            });
            return;
