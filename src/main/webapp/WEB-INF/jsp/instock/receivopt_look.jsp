                                        ...
                                        <c:if test="${QX.cha == 1 }">
                                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                                <tr id="${var.STOCKDTLMGRIN_ID}">
                                                    <td <c:if test="${'0' eq var.RECEI_FLG}">style="background-color: pink" </c:if> >${var.ROW_NO}</td>
                                                    <td <c:if test="${'0' eq var.RECEI_FLG}">style="background-color: pink" </c:if> >
                                                     <c:choose>
                                                        <c:when test="${'0' eq var.RECEI_FLG}">
                                                            ${var.INSTOCK_NO}
                                                        </c:when>
                                                        <c:otherwise>
                                                        </c:otherwise>
                                                    ...
                                                    <td <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                        <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>
                                                    >${var.EA_EA}</td>
                                                    <td <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                        <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>>${var.BIG_BOX_NO}</td>
                                                    <td <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                        <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>>${var.BOX_NO}</td>
                                                    <td  <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                         <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>>${var.EA_ACTUAL}</td>
                                                    <td  <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                         <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>>${var.ASSIGNED_EA}</td>
                                                    <td  <c:if test="${'0'==var.RECEI_FLG}">style="text-align: right;background-color: pink" </c:if>
                                                         <c:if test="${'1'==var.RECEI_FLG}">style="text-align: right;" </c:if>>${var.PUT_EA}</td>
