					...
					<div class="widget-body">
						...
						<div class="widget-toolbox">
							<div class="btn-toolbar">
								<div class="btn-group">
									<a class="btn btn-mini btn-primary" onclick="saveHead(1);"><span class="icon-eye-open"></span>手工码放-整单</a>
									<%--<a class="btn btn-mini btn-warning" onclick="save(2);"><span class="icon-undo"></span>取消码放</a>--%>
									&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
									&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
									&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
									&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						...
						<div class="widget-toolbox">
							<div class="btn-toolbar">
								<div class="btn-group">
									<a class="btn btn-mini btn-primary" onclick="save(1);"><span class="icon-eye-open"></span>手工码放-明细</a>
								</div>
							</div>
