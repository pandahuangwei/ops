...
<script type="text/javascript">
	...
	function save(pid){
		...
		//判断是哪个按钮的事件
		/*if (pid == 1) {
			$('#Form').attr("action", "receivopt/save.do?OPT_EVEN="+pid).submit();
		} else {
			$('#Form').attr("action", "receivopt/save.do?OPT_EVEN="+pid).submit();
		}*/
		$('#Form').attr("action", "receivopt/save.do?OPT_EVEN="+pid).submit();
...
<body>
<%--action="receivopt/${msg }.do" onsubmit="save(1);return false;" action="receivopt/save.do"  --%>
	<%--<form action="receivopt/save.do" name="Form" id="Form" method="post">--%>
						...
						<div class="slim-scroll" data-height="125">
							<div class="content">
								<table id="table_report" class="table table-striped  table-hover table-condensed">
									<c:choose>
									<c:when test="${pd.RECEIV_TYPE != null and pd.RECEIV_TYPE == 'REOTEC'}">
									<tr>
									...
									<tr>
										...
										<tr>
											...
											<td><input type="text" name="BIN_CODE" id="BIN_CODE" value="${pd.BIG_BOX_NO}" maxlength="32" placeholder=" " title="BIN_CODE"
													   /></td>

											<td style="width:70px;text-align: right;padding-top: 13px;"></td>

											<td><input type="hidden" value="解决bootstrap与AJAX异步提交表单的冲突"/></td>
										</tr>
