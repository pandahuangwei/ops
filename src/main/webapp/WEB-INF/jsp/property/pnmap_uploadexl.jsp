...
<body>
	<form action="pnmap/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
					...
					<div class="widget-toolbox">
						<div class="btn-toolbar">
							<div class="btn-group">
								...
								<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/pnmap/downExcel.do'">下载模版</a>
							</div>
						</div>
					</div>
	...
	<script src="static/js/ace.min.js"></script>
		...
		function closeW(){
			bootbox.confirm("数据导入成功!点击确认关闭.", function(result) {
				if(result) {
					top.Dialog.close();
				}
			});
