...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="select/list.do" method="post" name="Form" id="Form">
								...
								<div class="content">
									<table id="table_prod_dtl" class="table table-striped table-condensed table-hover">
										<tr>
											...
											<td><input type="text" name="GROUP_NAME" id="GROUP_NAME" value="${pd.GROUP_NAME}" maxlength="32" placeholder="" title="参数分组"/></td>
<%--
					...
					<c:when test="${not empty varList}">
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr id="${var.GROUP_KEY}">
								...
								<input type='hidden' name='ids' value="${var.SELECT_ID}" />
                                    ...
                                    <div class='hidden-phone visible-desktop btn-group'>
                                        ...
                                        <c:if test="${QX.edit != 1 && QX.del != 1 }">
                                            <span class="label label-large label-grey arrowed-in-right arrowed-in"><i class="icon-lock" title="无权限"></i></span>
                                             ...
                                             <c:if test="${QX.edit == 1 }">
                                                    <a title="编辑" onclick="edit('${var.GROUP_KEY}');" class='btn btn-mini btn-info' data-rel="tooltip" title="" data-placement="left"><i class="icon-edit"></i></a>
                                                </c:if>
                                                <%--<c:if test="${QX.del == 1 }">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>select/goEdit.do?GROUP_KEY='+Id;
			 diag.Width = 800;
			 diag.Height = 600;
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>select/excel.do';
		}
		</script>
