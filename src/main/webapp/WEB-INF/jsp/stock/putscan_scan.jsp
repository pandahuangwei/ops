...
<form action="putlocatoropt/saveScane1.do" name="Form" id="Form" method="post">
		...
		<div class="widget-box">
			...
			<div class="widget-body">
						...
						<div class="content">
							<table class="table table-striped table-hover table-condensed">
								<tr>
									...
									<td style="width:70px;text-align: right;padding-top: 13px;">外箱/内箱</td>
									<td><input type="text" name="BOX_NO" id="BOX_NO" value="${pd.BOX_NO}" maxlength="32" title="外箱/内箱号"/>
				...
				<div class="widget-toolbox padding-8 clearfix">
					<div class="btn-group">
						<a class="btn btn-primary btn-mini" onclick="save();" id="productc"><i class="icon-camera-retro"></i>扫描转移</a>
...
<script type="text/javascript">
	...
	function auditBoxNo(boxNo) {
		...
		$.ajax({
			type: "POST",
			url: '<%=basePath%>putlocatoropt/auditBoxNoForScan.do',
