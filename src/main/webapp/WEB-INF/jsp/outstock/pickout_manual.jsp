...
<html lang="en">
   ...
   <script type="text/javascript">
	...
	function manualPick(pid) {
		...
		if (str == '') {
			...
			if (flag) {
				...
				diag.Drag = true;
				diag.Title = "拆箱信息";
				diag.URL = '<%=basePath%>pickout/goBeakBox.do?OPT_EVEN=' + pid +"&STOCKMGROUT_ID_CHOSE="+str+"&STOCKMGROUT_IDS="+STOCKMGROUT_IDS;
				diag.Width = 800;
				diag.Height = 600;
	...
	function hadProd(ids) {
		var result = false;
		var STOCKMGROUT_IDS = $('#STOCKMGROUT_IDS').val();
		$.ajax({
			type: "POST",
			url: '<%=basePath%>pickout/hadNeedBreakBox.do',
			data: {STOCKMGROUT_ID_CHOSE:ids,STOCKMGROUT_IDS:STOCKMGROUT_IDS,tm:new Date().getTime()},
			dataType:'json',
			cache: false,
			async: false,
	...
	//整单拣货时候判断是否
	function hadProd2(ids) {
		var result = false;
		$.ajax({
			type: "POST",
			url: '<%=basePath%>pickout/hadBreakBox.do',
			data: {STOCKMGROUT_ID_CHOSE:ids,tm:new Date().getTime()},
			dataType:'json',
			cache: false,
			async: false,
			success: function(data){
				...
				<div class="widget-body">
					...
					<div class="widget-toolbox">
						<div class="btn-toolbar">
							<div class="btn-group">
								<a class="btn btn-mini btn-primary" onclick="manualPick(1);"><span class="icon-ok"></span>整单拣货</a>
							</div>
							<%--&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
			...
			<div class="widget-box">
				...
				<div class="widget-body">
					...
					<div class="widget-toolbox">
						<div class="btn-toolbar">
							<div class="btn-group">
								<a class="btn btn-mini btn-primary" onclick="manualPick2(2);"><span class="icon-ok"></span>明细拣货</a>
							</div>
							<%--&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
