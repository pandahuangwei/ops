...
<script type="text/javascript">
	...
	function manualCancel(pid) {
		...
		if (str == '') {
			...
			$('#Form').attr("action", "depotout/saveDepotCancel.do?OPT_EVEN="+pid+"&STOCKMGROUT_ID_CHOSE="+str).submit();
...
<form action="depotout/goDepotCacel.do" name="Form" id="Form" method="post">
										...
										<c:forEach items="${assignList}" var="var" varStatus="vs">
											<tr>
												...
												<td <c:if test="${161==var.CARGO_STATE}">style="background-color: red" </c:if>
													<c:if test="${162==var.CARGO_STAT}">style="background-color: yellow" </c:if>
