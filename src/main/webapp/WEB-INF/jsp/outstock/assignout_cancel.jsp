			...
			<div class="widget-body">
				...
				<div class="widget-toolbox">
					<div class="btn-toolbar">
						...
						<div class="btn-group">
							<a class="btn btn-mini btn-warning" onclick="manualCancel(4);"><span class="icon-undo"></span>整行取消</a>
						</div>
						&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
						&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
			...
			<div class="widget-body">
				...
				<div class="widget-toolbox">
					<div class="btn-toolbar">
						<div class="btn-group">
							<c:if test="${QX.add == 1 }">
								<a class="btn btn-mini btn-warning" onclick="manualCancel2(4);"><span class="icon-undo"></span>明细取消</a>
							</c:if>
						</div>
					</div>
									...
									<c:if test="${QX.cha == 1 }">
										<c:forEach items="${assignList}" var="var" varStatus="vs">
											<tr>
												...
												<td class='center' style="width: 30px;">
													<label><input type='checkbox' name='ids1' value="${var.COMB_ID}" /><span class="lbl"></span></label>
												</td>
