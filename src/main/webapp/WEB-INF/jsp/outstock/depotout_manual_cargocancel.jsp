   ...
   <script type="text/javascript">
	...
	function manualDepot2(pid) {
		...
		if (str == '') {
			...
			$('#Form').attr("action", "depotout/saveDepotManual.do?OPT_EVEN="+pid+"&STOCKMGROUT_ID_CHOSE="+str).submit();
	...
	function manualCancel(pid) {
		...
		if (str == '') {
			...
			$('#Form').attr("action", "depotout/saveDepotCargoCacel.do?OPT_EVEN="+pid+"&STOCKMGROUT_ID_CHOSE="+str).submit();
											...
											<c:if test="${QX.cha == 1 }">
												<c:forEach items="${varList}" var="var" varStatus="vs">
													<tr>
														...
														<td style="text-align: right">${var.DEPOT_EA_TOTAL}</td>
													</tr>
