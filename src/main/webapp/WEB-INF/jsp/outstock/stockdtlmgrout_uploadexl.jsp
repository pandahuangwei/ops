...
<body>
	<form action="stockmgrout/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
					...
					<div class="widget-toolbox">
						<div class="btn-toolbar">
							<div class="btn-group">
								...
								<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/stockmgrout/downExcel.do'">下载模版</a>
							</div>
						</div>
					</div>
