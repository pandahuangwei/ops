   ...
   <script type="text/javascript">
	...
	function cargoCancel(pid) {
		...
		if (str == '') {
			...
			$('#Form').attr("action", "cargoout/saveCargoCancel.do?OPT_EVEN="+pid+"&STOCKMGROUT_ID_CHOSE="+str).submit();
	...
	<form action="cargoout/goCargoCancel.do" name="Form" id="Form" method="post">
				...
				<div class="widget-body">
					...
					<div class="widget-toolbox">
						<div class="btn-toolbar">
							<div class="btn-group">
								<a class="btn btn-mini btn-warning" onclick="cargoCancel(4);"><span class="icon-undo"></span>取消配载</a>
							</div>
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
										...
										<c:if test="${QX.cha == 1 }">
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													...
													<td>${var.CARGO_NO}</td>
													<td style="text-align: center" <c:if test="${'2'==var.CARGO_TYPE}">style="background-color: pink" </c:if>>
														<c:if test="${'2'==var.CARGO_TYPE}">缺省</c:if>
														<c:if test="${'1'==var.CARGO_TYPE}">详情 </c:if>
													</td>
												</tr>
