package com.hw.controller.${packageName};
...
import com.hw.service.${packageName}.${objectName}Service;
...
<#list fieldList as var>
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("${packageName}/${objectNameLower}_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("${packageName}/${objectNameLower}_edit");
