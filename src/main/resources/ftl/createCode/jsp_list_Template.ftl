                                    ...
                                    <div class='hidden-phone visible-desktop btn-group'>
                                        ...
                                        <c:if test="${r"${QX.edit != 1 && QX.del != 1 }"}">
                                            <span class="label label-large label-grey arrowed-in-right arrowed-in"><i class="icon-lock" title="无权限"></i></span>
                                             ...
                                             <c:if test="${r"${QX.edit == 1 }"}">
                                                    <a title="编辑" onclick="edit('${r"${var."}${objectNameUpper}_ID${r"}"}');" class='btn btn-mini btn-info' data-rel="tooltip" title="" data-placement="left"><i class="icon-edit"></i></a>
                                                </c:if>
                                                <c:if test="${r"${QX.del == 1 }"}">
                                                    <a title="删除" onclick="del('${r"${var."}${objectNameUpper}_ID${r"}"}');" class='btn btn-mini btn-danger'  data-rel="tooltip" title="" data-placement="left"><i class="icon-trash"></i></a>
                                                </c:if>
                                    </div>
                                </td>
