...
public class ImageRemarkUtil {
    ...
    public static void main(String[] args) {
        String srcImgPath = "C:/yifu.jpg";
        String logoText = "复 印 无 效";
        String iconPath = "C:/water.png";

        String targerTextPath = "c:/qie_text.jpg";
        String targerTextPath2 = "c:/qie_text_rotate.jpg";

        String targerIconPath = "c:/qie_icon.jpg";
        String targerIconPath2 = "c:/qie_icon_rotate.jpg";
